...
#define PWM_L 10
#define PWM_R 11
#define DIR_L1 6              //DONE
#define DIR_L2 12             //DONE
#define DIR_R1 8              //DONE
#define DIR_R2 9              //DONE
#define SPD_INT_L 3//PIN1
#define SPD_PUL_L 4
#define SPD_INT_R 4//PIN7
#define SPD_PUL_R 5
#define MPU_INT 2    // PIN0  //DONE
#define K_AGL_AD A0
...
//    angular_rate_X = -((double)gyro[0]/131.0); // converted to radian
    angle = ypr[2] + 0.06;                   // 0.02 is center of gravity offset
    angular_rate = -((double)gyro[2]/131.0); // converted to radian
/*
...
void speed_int_l()
{
   Serial.print("speed_int_l triggered\n");
...
void speed_int_r()
{
  Serial.print("speed_int_r triggered\n");
