...
void loop()
{
  if (stringComplete) 
  {
    if (inChar[0] == 'R' && inChar[1] == 'G' && inChar[2] == 'B' && inChar[4] == 'A')
    {
      Mode = 0;
    }
    else if (inChar[0] == 'R' && inChar[1] == 'G' && inChar[2] == 'B' && inChar[4] == 'R')
    {
      Mode = 1;
      char RED[3];
      RED[0] = inChar[6];
    ...
    else if (inChar[0] == 'R' && inChar[1] == 'G' && inChar[2] == 'B' && inChar[4] == 'G')
    {
      Mode = 1;
      char GREEN[3];
      GREEN[0] = inChar[6];
    ...
    else if (inChar[0] == 'R' && inChar[1] == 'G' && inChar[2] == 'B' && inChar[4] == 'B')
    {
      Mode = 1;
      char BLUE[3];
      BLUE[0] = inChar[6];
    ...
    if (inChar[0] == 'V' && inChar[1] == ':')
    {
      ...
      Serial.print(VolumeLevel);
      Serial.print("\t");
      Serial.println(map (VolumeLevel,0,100,0,255));
      
      analogWrite(redPin, map (VolumeLevel,0,100,0,255));
      delay(50);
      analogWrite(grnPin, map (VolumeLevel,0,100,0,255)); 
      delay(50);
      analogWrite(bluPin, map (VolumeLevel,0,100,0,255));
      ...
      if (ran == 1 )
      {
        analogWrite(redPin, map (VolumeLevel,0,100,0,255));   // Write current values to LED pins
        //analogWrite(grnPin, random(1, 50)); 
        //analogWrite(bluPin, random(1, 50));
      ...
      {
        analogWrite(grnPin, map (VolumeLevel,0,100,0,255)); 
        //analogWrite(redPin, random(1, 50));
        //analogWrite(bluPin, random(1, 50));
      }
      else if (ran == 3 )
      {
        analogWrite(bluPin, map (VolumeLevel,0,100,0,255));
        //analogWrite(redPin, random(1, 50));   // Write current values to LED pins
        //analogWrite(grnPin, random(1, 50)); 
  ...
  case 1:    // your hand is on the sensor
    // if ((SetR > 0 ) && (SetG > 0) && (SetB > 0))
    // {
    analogWrite(redPin, SetR);   // Write current values to LED pins
    analogWrite(grnPin, SetG);      
    analogWrite(bluPin, SetB); 
    // }
  }
}
